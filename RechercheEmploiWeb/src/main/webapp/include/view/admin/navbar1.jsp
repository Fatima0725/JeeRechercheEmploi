                                    ...
                                    <ul>
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="../assets/images/avatar/1.jpg"mages/avatar/1.jpg" alt="">
                        ...
                        <li class="icons dropdown">
                            ...
                            <div class="drop-down dropdown-profile   dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li>
                                           <span><c:if test="${ !empty sessionScope.email }"> 
                                        ...
                                        <li><a href='<c:url value="/logout" />'><i class="icon-key"></i> <span>Logout</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
