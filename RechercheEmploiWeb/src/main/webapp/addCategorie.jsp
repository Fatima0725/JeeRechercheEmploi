...
<h3 class="register-heading">New Category</h3>
...
<div class="col-md-12 profile_card">
 <form class="form-inline" action="addCategorie" method="post">
    <div class="form-group">
        <i class="fa fa-envelope-o"></i>
        <input type="text" name="nom" class="form-control" placeholder="Name" value="" required />
    </div>
    ...
    <div class="float-right">
      ...
      <div class="float-right">
      <a class="btn btn-danger" role="button" href="include/view/admin.jsp">Cancel</a>
      </div>
     </form>
</div>
</div>
