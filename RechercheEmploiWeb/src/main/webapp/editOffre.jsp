...
<h3 class="register-heading">Edit Offer</h3>
<form action="offre" method="post">
<div class="row register-form">
<div class="col-md-6">
    <div class="form-group">
        <input type="text" name="titrePoste" class="form-control" placeholder="Title *" value="${offre.titrePoste }">
    </div>
    <div class="form-group">
        <input type="text" name="description" class="form-control" placeholder="Description *" value="${offre.titrePoste }">
    </div>
     <div class="form-group">
        <input type="datetime-local" name="datePublication" class="form-control" placeholder="Date Publication *" value="${offre.datePublication}">

    </div>
    <div class="form-group">
        <input type="text" name="postuler" class="form-control" placeholder="Contact *" value="${offre.postuler }">
    ...
    <div class="form-group">
       <label for="category">Catégorie :</label>
		<select name="category" id="category">
		  <option value="">-- Choisissez sa catégorie --</option>
