...
<h3 class="register-heading">New CV</h3>
...
<div class="col-md-6">
    ...
    <div class="form-group">
        <input type="text" name="telephone" maxlength="9" minlength="9" class="form-control" placeholder="Phone *" value="">
    </div>
	<div class="form-group">
...
<div class="col-md-6">
    <div class="form-group">
 	...
 	<div class="form-group">
         <input type="text" name="specialite" class="form-control" placeholder="Specialité *" value="">
     </div> 
     <div class="form-group"> 
         <input type="text" name="experienceProfessionnel" class="form-control" placeholder="Experience Professionnelle *" value="">
     </div>
      <div class="form-group">
         <input type="text" name="niveauEtude" class="form-control" placeholder="Niveau d'étude *" value="">
     </div>
    <div class="form-group">
